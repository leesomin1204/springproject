...
public class AccessTokenTest {
    ...
    void test() {
        ...
        body.add("client_id", "c6204c49ba377dd1f4fd5cd688be9b81");
        body.add("redirect_uri", "http://localhost:3000/member/social/callback/kakao");
        body.add("code", "GPo0-aJiTytXC5vvRJtrOdml89y74U4AtwbpowDqos76zSp5l1b2kAAAAAQKDSAbAAABmButDlXMISgqRbFCUQ");
