...
public class MemberController {
    ...
    // 회원가입 양식
    @GetMapping("/join")
    public String join(@ModelAttribute RequestJoin form, Model model, @SessionAttribute(name="socialType", required = false) SocialType type, @SessionAttribute(name="socialToken", required = false) String socialToken) {
